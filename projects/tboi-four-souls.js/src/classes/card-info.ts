...
export const playerCardInfo = [
    ...
    [ORIGIN_SET.REQUIEM, 'The Deserter', '', 'Anima Sola', 2, 1],
    ...
    [ORIGIN_SET.REQUIEM_WARP_ZONE, 'Quote', '(Tap Effect) Flip an eternal item you control if able, then recharge it.', 'Polar Star', 2, 1],
